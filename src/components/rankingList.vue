...
export default {
    ...
    data(){
        return {
            ...
            newRank:[
                {name:'哈哈:爱情不走心3',num:98562,bookId:123},
                {name:'哈哈:爱情不走心3',num:98562,bookId:123},
                {name:'哈哈:爱情不走心3',num:98562,bookId:123},
                {name:'哈哈:爱情不走心3',num:98562,bookId:123},
                {name:'哈哈:爱情不走心3',num:98562,bookId:123},
...
.ranking-list .button {
  height: .52rem;
  border-bottom: solid .02rem #f1f1f1;
}
...
.container.ranking-list .nv_active {
  color: #ff5858;
  border-left: solid .06rem #ff5858;
}
</style>
