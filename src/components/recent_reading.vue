<template>
    <div class="recent-reading">
        ...
        <div class="content" v-for="(item,index) in readList" :key="index" v-if="readList.length">
            <router-link :to="{name:'chapter',query:{bookId:item.bookid,chapterId:item.last_chapter_id}}" class="clearfix">
                <div class="img">
