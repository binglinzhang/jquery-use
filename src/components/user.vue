...
@import url('../common/color.less');
   .user .user-info {
    ...
    .user .user-info .user-asset {
      ...
      -webkit-box-shadow: 0 0 .6rem 0 #fdeaea;
      box-shadow: 0 0 .6rem 0 #fdeaea;
    }
    ...
    .user .user-info .user-money .num{margin-left: 6px;color: goldenrod}
    .user .user-info .user-money .left,.user .user-info .user-money .right{
        width: 50%;
    }
    .user .user-info .user-money .left{padding-right: 16px;text-align: right}
    .user .user-info .user-money .right{padding-left: 16px;text-align: left}
    ...
    .user .content:nth-child(1) b {
      ...
      width: .4rem;
      height: .4rem;
      background: url(data:image/png;base64,) no-repeat center;
